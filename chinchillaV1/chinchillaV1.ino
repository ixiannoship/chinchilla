...
// Variables globales para los valores a mostrar
...
void handleRoot() {
  ...
  //response += "<html><head><meta charset=\"UTF-8\"><title>Chinchila/Trydan</title></head><body>";
  ...
  response += "<br>";
  response += "<p>Producción Fotovoltaica: " + String(fv) + "</p>";
  ...
  response += "<p>Importando/Excedentes (en negativo): " + String(int(gridi)) + "</p>";
